<template>
  <section class="user-profile-svg">
       <div class="svg-trip" data-reactroot="">
      <svg
        focusable="false"
      ...
      >
        <g style="isolation: isolate">
          <path
            ...
            fill="#ffd46b"
          ></path>
          <path fill="#ffd46b" d="M84.9 91.96h164.23v65.31H84.9z"></path>
          <path
            fill="#fff"
          ...
          ></path>
          <path fill="#ff8e8f" d="M788.35 207.8h35.12v21.67h-35.12z"></path>
          <path fill="#c6e7e0" d="M823.47 213.74h28.19v15.73h-28.19z"></path>
          <path
          ...
          <g>
            ...
            <g fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="#407f7f" d="M6.35 207.63l52.52-31.96"></path>
              <path
            ...
            ></path>
            <g fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="#407f7f" d="M327.04 207.63l-52.53-31.96"></path>
              <path
